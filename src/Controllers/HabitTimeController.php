...
class HabitTimeController extends Controller
{
    ...
    {
        $fields = $request->validated();
        $response = $this->habitService->updateHabitTransaction($habitTimeId, Auth::user()->id, Auth::user()->timezone, $fields);
        if ($response) {
    ...
    /**
     * Toggle timer for a habit (authenticated AJAX endpoint)
     *
     * @param int $habitId
     * @param string $status
     * @return JsonResponse
    ...
    /**
     * Save a value for a habit (authenticated AJAX endpoint)
     *
     * @param int $habitId
     * @param \Illuminate\Http\Request $request
     * @return JsonResponse
     */
    public function saveValue(int $habitId, \Illuminate\Http\Request $request): JsonResponse
    {
